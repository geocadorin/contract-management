        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-gray-800">{owner.uf_rg || 'Não informado'}</p>
            </div>

            <div>
              <p className="text-sm font-semibold text-gray-600">Gênero</p>
              <p className="text-gray-800">{owner.gender || 'Não informado'}</p>
            </div>

            <div>
              <p className="text-sm font-semibold text-gray-600">Nacionalidade</p>
              <p className="text-gray-800">{owner.nationality || 'Não informado'}</p>
            </div>

            <div>
              <p className="text-sm font-semibold text-gray-600">Agência Bancária</p>
              <p className="text-gray-800">{owner.branch || 'Não informado'}</p>
            </div>

            <div>
              <p className="text-sm font-semibold text-gray-600">Número da Conta</p>
              <p className="text-gray-800">{owner.account || 'Não informado'}</p>
            </div>

            <div>
              <p className="text-sm font-semibold text-gray-600">Nome do Banco</p>
              <p className="text-gray-800">{owner.bank || 'Não informado'}</p>
            </div>

            <div>
              <p className="text-sm font-semibold text-gray-600">Tipo de Conta</p>
              <p className="text-gray-800">{owner.account_type || 'Não informado'}</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-gray-800">{formatPhone(owner.cellphone)}</p>
            </div>
