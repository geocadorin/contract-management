            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-col">
                  ...
                  <span className={`font-medium ${realEstate.status_real_estate === 'Disponível' ? 'text-green-600' :
                ...
                <div className="flex flex-col">
                  <span className="text-sm text-gray-500">Inscrição Municipal</span>
                ...
                <div className="flex flex-col">
                  <span className="text-sm text-gray-500">Concessionária de Energia</span>
                  <span className="font-medium">{realEstate.energy_concessionaire || '-'}</span>
                </div>

                <div className="flex flex-col">
                  <span className="text-sm text-gray-500">Concessionária de Água</span>
                  <span className="font-medium">{realEstate.water_concessionaire || '-'}</span>
                </div>

                <div className="flex flex-col">
                  <span className="text-sm text-gray-500">Categoria do Imóvel</span>
                  <span className="font-medium">{realEstate.property_category || '-'}</span>
                </div>

                <div className="flex flex-col">
                  <span className="text-sm text-gray-500">Data do Relatório de Vistoria</span>
                  <span className="font-medium">{realEstate.inspection_report_date || '-'}</span>
                </div>
              </div>
            </div>
