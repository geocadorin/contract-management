...
import { FiHome, FiUsers, FiSearch, FiPlus, FiLogOut, FiFileText, FiKey } from 'react-icons/fi';
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex">
            <Link to="/" className="flex-shrink-0 flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-gray-800">Gestão de Contratos</span>
            </Link>
          </div>
          ...
          <div className="flex items-center">
            ...
            <button
              ...
              className="ml-4 flex items-center px-4 py-2 text-red-600 hover:bg-red-50 rounded-md"
            >
